...
<TouchableNativeFeedback onPress={() => navigation.navigate('TransaksiPage')}>
<View style={{padding:10, backgroundColor:colors.white, borderRadius:5,flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
  <Image source={require('../../assets/transaksi.png')} style={{width:51, height:51, left:-100}}/>
  <Text style={{fontFamily:fonts.primary[600], fontSize: MyDimensi/3, marginLeft:-50}}>Transaksi</Text>
</View>
</TouchableNativeFeedback>
...
<TouchableNativeFeedback onPress={() => navigation.navigate('ManajemenPage')}>
<View style={{padding:10, backgroundColor:colors.white, borderRadius:5,flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
  <Image source={require('../../assets/manajemen.png')} style={{width:51, height:51, left:-90}}/>
  <Text style={{fontFamily:fonts.primary[600], fontSize: MyDimensi/3, marginLeft:-50}}>Manajemen</Text>
</View>
</TouchableNativeFeedback>
